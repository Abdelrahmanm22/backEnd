...
//   echo ;die;
  ...
  if(isset($_FILES['avatar']['name'])){
    ...
    move_uploaded_file($avatartmpName,"upload/".$avatarfileName);
  }

  if(isset($_FILES['cv']['name'])){
    $cvtmpName = $_FILES['cv']['tmp_name'];
    $cvfileName = $_FILES['cv']['name'];
    move_uploaded_file($cvtmpName,"upload/".$cvfileName);
  }

  $res = updateSetting($id,$title,$about,$avatarfileName,$cvfileName);
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="updateSettings.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>update Settings</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(!empty($error) or !empty($success) ): ?>
        <div class="alert <?php if(!empty($error)): ?> alert-danger<?php else: ?> alert-success <?php endif;?>  alert-dismissible">
              ...
              <form action="updateSettings.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter Title" value="<?= $settings['title'];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputDescription">About</label>
                    <textarea name="about" id="exampleInputDescription"  class="form-control" cols="30" rows="10"><?= $settings['about'];?></textarea>
                  </div>
                  <img src="upload/<?= $settings['avatar'];?>" alt="img" width="200px" height="200px">
                  <div class="form-group">
                  ...
                  <input type="hidden" name="proid" value="<?=$projectData['portfolio_id'];?>">
