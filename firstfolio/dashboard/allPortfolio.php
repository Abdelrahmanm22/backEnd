  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="#" class="d-block"><?= $_SESSION['user']['user_name']; ?></a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Portfolios</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <tbody>
                <?php foreach($projects as $pro):?>
                  <tr>
                    ...
                    <td><img src="upload/<?php echo $pro['img']; ?>" alt="img" width="100px" height="100px"></td>
                    <td><?php echo $pro['user_name']; ?></td>
                    <td ><a href="updatePortfolio.php?proid=<?= $pro['portfolio_id']; ?>" class="btn btn-secondary">Update</a> </td>
                    
                    <td ><a href="deletePortfolio.php?proid=<?= $pro['portfolio_id']; ?>" class="btn btn-danger">Delete</a> </td>
                  </tr>
                <?php endforeach;?>
            </tbody>
        </table>
