...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $res = updatePortfolio($id,$title,$desc,$fileName);
  ...
  $projectData =getPortfoliosbyID($_GET['proid']);
}
?>
              ...
              <form action="updatePortfolio.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter Title" value="<?= $projectData['title'];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputDescription">Description</label>
                    <textarea name="desc" id="exampleInputDescription"  class="form-control" cols="30" rows="10"><?= $projectData['description'];?></textarea>
                  </div>
                  <img src="upload/<?= $projectData['img'];?>" alt="img">
                  <div class="form-group">
